...
const file_pipeline_v1_lemma_service_proto_rawDesc = "" +
	"\n" +
	"\x1fpipeline/v1/lemma_service.proto\x12\vpipeline.v1\x1a\x15common/v1/types.proto\x1a\x1apipeline/v1/pipeline.proto\"k\n" +
	"\x11ListLemmasRequest\x12<\n" +
	"\n" +
	"pagination\x18\x01 \x01(\v2\x1c.common.v1.PaginationRequestR\n" +
	"pagination\x12\x18\n" +
	"\akeyword\x18\x02 \x01(\tR\akeyword\"\x83\x01\n" +
...
var file_pipeline_v1_lemma_service_proto_goTypes = []any{
	...
	(*LemmaItem)(nil),             // 3: pipeline.v1.LemmaItem
...
var file_pipeline_v1_lemma_service_proto_depIdxs = []int32{
	...
	3, // 1: pipeline.v1.ListLemmasResponse.lemmas:type_name -> pipeline.v1.LemmaItem
