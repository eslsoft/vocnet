...
const file_pipeline_v1_pipeline_proto_rawDesc = "" +
	...
	"\x17PIPELINE_STATUS_SKIPPED\x10\a*\xaa\x01\n" +
	"\rPipelinePhase\x12\x1e\n" +
	"\x1aPIPELINE_PHASE_UNSPECIFIED\x10\x00\x12\x1d\n" +
	"\x19PIPELINE_PHASE_COLLECTION\x10\x01\x12\x1d\n" +
	"\x19PIPELINE_PHASE_EVALUATION\x10\x02\x12\x1e\n" +
	"\x1aPIPELINE_PHASE_INTEGRATION\x10\x03\x12\x1b\n" +
	"\x17PIPELINE_PHASE_SNAPSHOT\x10\x04*{\n" +
