...
// Validate checks the field values on WordIDRequest with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *WordIDRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on WordIDRequest with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in WordIDRequestMultiError, or
// nil if none found.
func (m *WordIDRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *WordIDRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return WordIDRequestMultiError(errors)
	}

	return nil
}

// WordIDRequestMultiError is an error wrapping multiple validation errors
// returned by WordIDRequest.ValidateAll() if the designated constraints
// aren't met.
type WordIDRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m WordIDRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m WordIDRequestMultiError) AllErrors() []error { return m }

// WordIDRequestValidationError is the validation error returned by
// WordIDRequest.Validate if the designated constraints aren't met.
type WordIDRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e WordIDRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e WordIDRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e WordIDRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e WordIDRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e WordIDRequestValidationError) ErrorName() string { return "WordIDRequestValidationError" }

// Error satisfies the builtin error interface
func (e WordIDRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = WordIDRequestValidationError{}
